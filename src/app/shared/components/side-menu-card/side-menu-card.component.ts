...
export class SideMenuCardComponent {
  ...
  public users: Chats[] = [
    ...
    {id: 4, name: "Cami", message:"Qué mas?", date: "Miercoles", number: 4, avatar: this.crypoBot},
    ...
    {id: 7, name: "Valentina", message:"Si vio eso", date: "Viernes", number: 5, avatar: this.crypoBot},
    {id: 8, name: "Angular", message:"Signals al poder", date: "Jueves", number: 2, avatar: this.crypoBot},
    {id: 9, name: "Vue", message:"Svelte mi hijo", date: "Sábado", number: 3, avatar: this.crypoBot},
    {id: 10, name: "Java", message:"No se de java", date: "Viernes", number: 5, avatar: this.crypoBot},
  ]
